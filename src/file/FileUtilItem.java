...
public class FileUtilItem {
    ...
    public static void serializeItemMap(List<Item> itemList) throws IOException {
    ...
    public static List<Item> deserializeItemMap() throws IOException, ClassNotFoundException {
